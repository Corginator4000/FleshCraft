package com.Corginator4000.fleshcraft.library.network;
...
import com.Corginator4000.fleshcraft.library.mantle.network.NetworkWrapper;
//import com.Corginator4000.fleshcraft.library.Util;
...
public class FleshCraftNetwork extends NetworkWrapper {

    private static FleshCraftNetwork instance;

    private FleshCraftNetwork() {
        super(new ResourceLocation("fleshcraft", "network"));
    }

    public static synchronized FleshCraftNetwork getInstance() {
        if (instance == null) {
            setup();
        }
        return instance;
    ...
    public static void setup() {
        instance = new FleshCraftNetwork();
