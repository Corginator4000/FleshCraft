...
import com.Corginator4000.fleshcraft.library.network.FleshCraftNetwork;
import com.Corginator4000.fleshcraft.digestivechamber.network.ChamberTankUpdatePacket;
import com.Corginator4000.fleshcraft.digestivechamber.tileentity.tank.IChamberTankHandler.FluidChange;
 ...
 */
public class ChamberTank implements IFluidHandler {
    private final IChamberTankHandler parent;
    ...
    public ChamberTank(IChamberTankHandler parent) {
    ...
    public void syncFluids() {
        ...
        if (world != null && !world.isRemote) {
            ...
            //FleshCraftNetwork.getInstance().sendToClientsAround(new ChamberTankUpdatePacket(pos, fluids), world, pos);
        }
    }
